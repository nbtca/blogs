...
<p>这门课我们会使用开源测试框架 <a href="https://jestjs.io/en/" target="_blank" rel="noopener noreferrer">Jest<ExternalLinkIcon/></a>，它是 Facebook 出品的一个测试框架，相对其他测试框架，它的一大特点就是内置了常用的测试工具，比如自带断言、测试覆盖率工具，实现了开箱即用。</p>
