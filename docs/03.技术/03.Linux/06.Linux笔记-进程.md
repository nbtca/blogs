...
categories: 
  - 技术
  - Linux
cover: ./Linux笔记-进程.assets/20220320105749.png
...
![process-1](./Linux笔记-进程.assets/process-1.png)

![process-2](./Linux笔记-进程.assets/process-2.png)

`ps -aue`命令可以查看更为详细的信息：

![process-3](./Linux笔记-进程.assets/process-3.png)

`top`命令可以实时查看正在运行的程序：

![process-4](./Linux笔记-进程.assets/process-4.png)

在终端输入`top`，输入q可以退出：

![process-5](./Linux笔记-进程.assets/process-5.png)
...
1. `system`函数可以在命令行中执行命令，可以借此来创建一个进程，不作赘述
   ...
   ![process-6](./Linux笔记-进程.assets/process-6.png)

2. `fork`函数、`vfork`函数 创建子进程: 当前进程是父进程，被创建进程是子进程，创建完后父子进程通知执行

   ![process-7](./Linux笔记-进程.assets/process-7.png)

3. `exec`家族

   ![process-8](./Linux笔记-进程.assets/process-8.png)
...
![process-9](./Linux笔记-进程.assets/process-9.png)

这里有必要明确一下`fork`函数的返回值：

![process-10](./Linux笔记-进程.assets/process-10.png)
...
![process-11](./Linux笔记-进程.assets/process-11.png)
...
![process-12](./Linux笔记-进程.assets/process-12.png)
...
![process-13](./Linux笔记-进程.assets/process-13.png)
...
![process-14](./Linux笔记-进程.assets/process-14.png)

现在关闭终端，在命令行输入`ps -axj`，可以看到运行起来的守护进程还在运行：

![process-15](./Linux笔记-进程.assets/process-15.png)
...
![process-16](./Linux笔记-进程.assets/process-16.png)
...
![process-17](./Linux笔记-进程.assets/process-17.png)
...
![process-18](./Linux笔记-进程.assets/process-18.png)
...
![process-19](./Linux笔记-进程.assets/process-19.png)
...
![process-20](./Linux笔记-进程.assets/process-20.png)

![process-21](./Linux笔记-进程.assets/process-21.png)

![process-22](./Linux笔记-进程.assets/process-22.png)
