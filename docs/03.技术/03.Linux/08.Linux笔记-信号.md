...
categories: 
  - 技术
  - Linux
cover: ./Linux笔记-信号.assets/20220320105749.png
...
![signal-1](./Linux笔记-信号.assets/signal-1.png)

这里可以用man命令查看一下signal函数的帮助文档：

![signal-2](./Linux笔记-信号.assets/signal-2.png)

signal关联上了一个信号处理函数，来处理信号。

现在修改这个代码，添加一行打印当前进程号，然后打开两个终端，一个终端运行上面的程序，一个终端尝试`kill`命令来发送信号：

![signal-3](./Linux笔记-信号.assets/signal-3.png)

kill 要指定参数：

![signal-4](./Linux笔记-信号.assets/signal-4.png)
...
![signal-5](./Linux笔记-信号.assets/signal-5.png)
...
![signal-6](./Linux笔记-信号.assets/signal-6.png)

![signal-7](./Linux笔记-信号.assets/signal-7.png)

成功发送了信号。

`sigaction`函数有所不同，功能更多：

![signal-8](./Linux笔记-信号.assets/signal-8.png)

这里用到了一个结构体：

![signal-9](./Linux笔记-信号.assets/signal-9.png)
...
![signal-10](./Linux笔记-信号.assets/signal-10.png)

这里有个重要的联合体，用来存储数据和信号一起发送：

![signal-11](./Linux笔记-信号.assets/signal-11.png)
...
![](./Linux笔记-信号.assets/signal-12.png)

![signal-13](./Linux笔记-信号.assets/signal-13.png)
...
![signal-14](./Linux笔记-信号.assets/signal-14.png)

![signal-15](./Linux笔记-信号.assets/signal-15.png)
...
![](./Linux笔记-信号.assets/7cb86c73b9e73893e6b0e0433d476928.png)
