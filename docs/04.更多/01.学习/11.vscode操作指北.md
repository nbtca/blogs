...
cover: ./vscode操作指北.assets/try-code.png
categories: 
  - 更多
  - 学习
...
![](./vscode操作指北.assets/8cWuBzF4XeAjdE2.gif)

同时[vs code 内置 Emmet 支持](https://docs.emmet.io/cheat-sheet/)，前端是再合适不过了：

![](./vscode操作指北.assets/3R1HVIyfDLmTbdg.gif)

![vscode-emmet-css](./vscode操作指北.assets/TedcPw8KplHf2IY.gif)

除此之外，**丰富的扩展**还能支持其他语言的开发：

![vscode-go-hw](./vscode操作指北.assets/lUJINBQbGVD87c4.gif)

![vscode-rust-hw](./vscode操作指北.assets/WIliEaTm82ZBFGN.gif)

**重构**功能（快捷键`F2`）：

![vscode-cs-refractor](./vscode操作指北.assets/u7QD2qsrLR3YUeb.gif)
...
![image-20211025203252544](./vscode操作指北.assets/image-20211025203252544.png)

或者你可以点选左侧工具栏的**扩展(最下面)图标**，搜索框输入 Chinese，安装安装次数最高的那个语言插件并重启。

![image-20211025203716083](./vscode操作指北.assets/image-20211025203716083.png)
...
![image-20211025204559387](./vscode操作指北.assets/image-20211025204559387.png)
...
![image-20211025211048557](./vscode操作指北.assets/image-20211025211048557.png)

我们可以先新建一个`index.html`。

![vscode-new-file](./vscode操作指北.assets/vscode-new-file.gif)
...
![vscode-emmet](./vscode操作指北.assets/vscode-emmet.gif)
...
![image-20211026153717317](./vscode操作指北.assets/image-20211026153717317.png)

个人比较喜欢的编辑器配色插件。有三种方案可选。

当然，vscode 有好几种自带的配色方案，如果你觉得自带够用，你完全可以不安装这个插件！

![](./vscode操作指北.assets/normal.png)

#### vscode-icons

![image-20211026153649933](./vscode操作指北.assets/image-20211026153649933.png)

非常棒的图标库，为 vscode 添加及更新了许多文件和文件夹的图标（文件根据后缀名，文件夹根据名称自动更改图标）。

![image-20211026153545952](./vscode操作指北.assets/image-20211026153545952.png)
...
![image-20211025205452863](./vscode操作指北.assets/image-20211025205452863.png)
...
![vscode-suggest](./vscode操作指北.assets/vscode-suggest.gif)
...
![vscode-copy-by-line](./vscode操作指北.assets/vscode-copy-by-line.gif)
...
![vscode-multi-cursor-](./vscode操作指北.assets/vscode-multi-cursor-.gif)
...
![vscode-command](./vscode操作指北.assets/vscode-command.gif)
...
![image-20211025212005574](./vscode操作指北.assets/image-20211025212005574.png)
...
![image-20211027193202773](./vscode操作指北.assets/image-20211027193202773.png)
